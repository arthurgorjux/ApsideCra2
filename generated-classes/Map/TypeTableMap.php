...
class TypeTableMap extends TableMap
{
     ...
     */
    const COL_DESIGNATION = 'type.designation';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TypeTableMap::COL_ID, TypeTableMap::COL_DESIGNATION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TypeTableMap::COL_ID => 0, TypeTableMap::COL_DESIGNATION => 1, ),
    ...
    {
        $this->addRelation('Cellule', '\\Cellule', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':type_c',
    1 => ':id',
  ),
), null, null, 'Cellules', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TypeTableMap::COL_DESIGNATION);
        } else {

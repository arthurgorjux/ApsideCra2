...
class UtilisateurTableMap extends TableMap
{
    ...
    /**
     * the column name for the matricule field
     */
    const COL_MATRICULE = 'utilisateur.matricule';

    /**
     * the column name for the nom field
     */
    const COL_NOM = 'utilisateur.nom';

    /**
     * the column name for the prenom field
     */
    const COL_PRENOM = 'utilisateur.prenom';

    /**
     * the column name for the admin field
     */
    const COL_ADMIN = 'utilisateur.admin';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Matricule', 'Nom', 'Prenom', 'Admin', ),
        self::TYPE_CAMELNAME     => array('matricule', 'nom', 'prenom', 'admin', ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_MATRICULE, UtilisateurTableMap::COL_NOM, UtilisateurTableMap::COL_PRENOM, UtilisateurTableMap::COL_ADMIN, ),
        self::TYPE_FIELDNAME     => array('matricule', 'nom', 'prenom', 'admin', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Matricule' => 0, 'Nom' => 1, 'Prenom' => 2, 'Admin' => 3, ),
        self::TYPE_CAMELNAME     => array('matricule' => 0, 'nom' => 1, 'prenom' => 2, 'admin' => 3, ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_MATRICULE => 0, UtilisateurTableMap::COL_NOM => 1, UtilisateurTableMap::COL_PRENOM => 2, UtilisateurTableMap::COL_ADMIN => 3, ),
        self::TYPE_FIELDNAME     => array('matricule' => 0, 'nom' => 1, 'prenom' => 2, 'admin' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('matricule', 'Matricule', 'INTEGER', true, null, null);
        $this->addColumn('nom', 'Nom', 'VARCHAR', false, 255, null);
        $this->addColumn('prenom', 'Prenom', 'VARCHAR', false, 255, null);
        $this->addColumn('admin', 'Admin', 'BOOLEAN', false, 1, false);
    } // initialize()
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Matricule', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UtilisateurTableMap::COL_MATRICULE);
            $criteria->addSelectColumn(UtilisateurTableMap::COL_NOM);
            $criteria->addSelectColumn(UtilisateurTableMap::COL_PRENOM);
            $criteria->addSelectColumn(UtilisateurTableMap::COL_ADMIN);
        } else {
            $criteria->addSelectColumn($alias . '.matricule');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UtilisateurTableMap::COL_MATRICULE, (array) $values, Criteria::IN);
        }

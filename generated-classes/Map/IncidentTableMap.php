...
class IncidentTableMap extends TableMap
{
    ...
    /**
     * the column name for the cellule_i field
     */
    const COL_CELLULE_I = 'incident.cellule_i';

    /**
     * the column name for the etat_i field
     */
    const COL_ETAT_I = 'incident.etat_i';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CelluleI', 'EtatI', ),
        self::TYPE_CAMELNAME     => array('id', 'celluleI', 'etatI', ),
        self::TYPE_COLNAME       => array(IncidentTableMap::COL_ID, IncidentTableMap::COL_CELLULE_I, IncidentTableMap::COL_ETAT_I, ),
        self::TYPE_FIELDNAME     => array('id', 'cellule_i', 'etat_i', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CelluleI' => 1, 'EtatI' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'celluleI' => 1, 'etatI' => 2, ),
        self::TYPE_COLNAME       => array(IncidentTableMap::COL_ID => 0, IncidentTableMap::COL_CELLULE_I => 1, IncidentTableMap::COL_ETAT_I => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'cellule_i' => 1, 'etat_i' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('cellule_i', 'CelluleI', 'INTEGER', 'cellule', 'id', false, null, null);
        $this->addForeignKey('etat_i', 'EtatI', 'INTEGER', 'etat_incident', 'id', false, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('EtatIncident', '\\EtatIncident', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':etat_i',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(IncidentTableMap::COL_CELLULE_I);
            $criteria->addSelectColumn(IncidentTableMap::COL_ETAT_I);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.cellule_i');
            $criteria->addSelectColumn($alias . '.etat_i');
        }
    }

...
/**
 * Base class that represents a row from the 'etat_demande' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class EtatDemande implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EtatDemandeTableMap';
    ...
    /**
     * Initializes internal state of Base\EtatDemande object.
     */
    ...
    /**
     * Compares this with another <code>EtatDemande</code> instance.  If
     * <code>obj</code> is an instance of <code>EtatDemande</code>, delegates to
     * <code>equals(EtatDemande)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EtatDemande The current object, for fluid interface
     */
     ...
     * @return $this|\EtatDemande The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EtatDemandeTableMap::COL_ID] = true;
        }
    ...
    public function setDesignation($v)
    {
        ...
        if ($this->designation !== $v) {
            $this->designation = $v;
            $this->modifiedColumns[EtatDemandeTableMap::COL_DESIGNATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EtatDemandeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EtatDemandeTableMap::translateFieldName('Designation', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = EtatDemandeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EtatDemande'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEtatDemandeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EtatDemande::setDeleted()
     * @see EtatDemande::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEtatDemandeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EtatDemandeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EtatDemandeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EtatDemandeTableMap::COL_DESIGNATION)) {
            $modifiedColumns[':p' . $index++]  = 'designation';
        }

        $sql = sprintf(
            'INSERT INTO etat_demande (%s) VALUES (%s)',
    ...
    {
        $pos = EtatDemandeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EtatDemande'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EtatDemande'][$this->hashCode()] = true;
        $keys = EtatDemandeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EtatDemandeTableMap::COL_ID)) {
            $criteria->add(EtatDemandeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EtatDemandeTableMap::COL_DESIGNATION)) {
            $criteria->add(EtatDemandeTableMap::COL_DESIGNATION, $this->designation);
        }
    ...
    {
        $criteria = ChildEtatDemandeQuery::create();
        $criteria->add(EtatDemandeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EtatDemande (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EtatDemande Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEtatDemande is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEtatDemande The current object (for fluent API support)
     */
    public function setDemandes(Collection $demandes, ConnectionInterface $con = null)
    {
        ...
        foreach ($demandesToDelete as $demandeRemoved) {
            $demandeRemoved->setEtatDemande(null);
        }
     ...
     * Otherwise if this EtatDemande is new, it will return
     * an empty collection; or if this EtatDemande has previously
     * been saved, it will retrieve related Demandes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EtatDemande.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildDemande[] List of ChildDemande objects
     */
    public function getDemandesJoinCellule(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDemandeQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EtatDemandeTableMap::DEFAULT_STRING_FORMAT);
    }

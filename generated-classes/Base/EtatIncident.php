...
/**
 * Base class that represents a row from the 'etat_incident' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class EtatIncident implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EtatIncidentTableMap';
    ...
    /**
     * Initializes internal state of Base\EtatIncident object.
     */
    ...
    /**
     * Compares this with another <code>EtatIncident</code> instance.  If
     * <code>obj</code> is an instance of <code>EtatIncident</code>, delegates to
     * <code>equals(EtatIncident)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EtatIncident The current object, for fluid interface
     */
     ...
     * @return $this|\EtatIncident The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EtatIncidentTableMap::COL_ID] = true;
        }
    ...
    public function setDesignation($v)
    {
        ...
        if ($this->designation !== $v) {
            $this->designation = $v;
            $this->modifiedColumns[EtatIncidentTableMap::COL_DESIGNATION] = true;
        }
    ...
    public function setAbreviation($v)
    {
        ...
        if ($this->abreviation !== $v) {
            $this->abreviation = $v;
            $this->modifiedColumns[EtatIncidentTableMap::COL_ABREVIATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EtatIncidentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EtatIncidentTableMap::translateFieldName('Designation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->designation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EtatIncidentTableMap::translateFieldName('Abreviation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->abreviation = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = EtatIncidentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EtatIncident'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEtatIncidentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EtatIncident::setDeleted()
     * @see EtatIncident::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEtatIncidentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EtatIncidentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EtatIncidentTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EtatIncidentTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(EtatIncidentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EtatIncidentTableMap::COL_DESIGNATION)) {
            $modifiedColumns[':p' . $index++]  = 'designation';
        }
        if ($this->isColumnModified(EtatIncidentTableMap::COL_ABREVIATION)) {
            $modifiedColumns[':p' . $index++]  = 'abreviation';
        }

        $sql = sprintf(
            'INSERT INTO etat_incident (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'designation':
                        ...
                        break;
                    case 'abreviation':
                        $stmt->bindValue($identifier, $this->abreviation, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = EtatIncidentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EtatIncident'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EtatIncident'][$this->hashCode()] = true;
        $keys = EtatIncidentTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDesignation(),
            $keys[2] => $this->getAbreviation(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setAbreviation($arr[$keys[2]]);
        }
    }
    ...
    {
        $criteria = new Criteria(EtatIncidentTableMap::DATABASE_NAME);

        if ($this->isColumnModified(EtatIncidentTableMap::COL_ID)) {
            $criteria->add(EtatIncidentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EtatIncidentTableMap::COL_DESIGNATION)) {
            $criteria->add(EtatIncidentTableMap::COL_DESIGNATION, $this->designation);
        }
        if ($this->isColumnModified(EtatIncidentTableMap::COL_ABREVIATION)) {
            $criteria->add(EtatIncidentTableMap::COL_ABREVIATION, $this->abreviation);
        }
    ...
    {
        $criteria = ChildEtatIncidentQuery::create();
        $criteria->add(EtatIncidentTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EtatIncident (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAbreviation($this->getAbreviation());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EtatIncident Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildEtatIncident is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEtatIncident The current object (for fluent API support)
     */
    public function setIncidents(Collection $incidents, ConnectionInterface $con = null)
    {
        ...
        foreach ($incidentsToDelete as $incidentRemoved) {
            $incidentRemoved->setEtatIncident(null);
        }
     ...
     * Otherwise if this EtatIncident is new, it will return
     * an empty collection; or if this EtatIncident has previously
     * been saved, it will retrieve related Incidents from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EtatIncident.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildIncident[] List of ChildIncident objects
     */
    public function getIncidentsJoinCellule(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildIncidentQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EtatIncidentTableMap::DEFAULT_STRING_FORMAT);
    }

...
abstract class Incident implements ActiveRecordInterface
{
    ...
    /**
     * The value for the cellule_i field.
     *
     * @var        int
     */
    protected $cellule_i;
    ...
    /**
     * The value for the etat_i field.
     *
     * @var        int
     */
    protected $etat_i;
    ...
    /**
     * @var        ChildEtatIncident
     */
    protected $aEtatIncident;
    ...
    /**
     * Get the [cellule_i] column value.
     *
     * @return int
     */
    public function getCelluleI()
    {
        return $this->cellule_i;
    }

    /**
     * Get the [etat_i] column value.
     *
     * @return int
     */
    public function getEtatI()
    {
        return $this->etat_i;
    }
    ...
    /**
     * Set the value of [cellule_i] column.
     *
     * @param int $v new value
     * @return $this|\Incident The current object (for fluent API support)
     */
    public function setCelluleI($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->cellule_i !== $v) {
            $this->cellule_i = $v;
            $this->modifiedColumns[IncidentTableMap::COL_CELLULE_I] = true;
        }
    ...
    /**
     * Set the value of [etat_i] column.
     *
     * @param int $v new value
     * @return $this|\Incident The current object (for fluent API support)
     */
    public function setEtatI($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->etat_i !== $v) {
            $this->etat_i = $v;
            $this->modifiedColumns[IncidentTableMap::COL_ETAT_I] = true;
        }

        if ($this->aEtatIncident !== null && $this->aEtatIncident->getId() !== $v) {
            $this->aEtatIncident = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : IncidentTableMap::translateFieldName('CelluleI', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cellule_i = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : IncidentTableMap::translateFieldName('EtatI', TableMap::TYPE_PHPNAME, $indexType)];
            $this->etat_i = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = IncidentTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aCellule !== null && $this->cellule_i !== $this->aCellule->getId()) {
            $this->aCellule = null;
        }
        if ($this->aEtatIncident !== null && $this->etat_i !== $this->aEtatIncident->getId()) {
            $this->aEtatIncident = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aEtatIncident !== null) {
                if ($this->aEtatIncident->isModified() || $this->aEtatIncident->isNew()) {
                    $affectedRows += $this->aEtatIncident->save($con);
                }
                $this->setEtatIncident($this->aEtatIncident);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(IncidentTableMap::COL_CELLULE_I)) {
            $modifiedColumns[':p' . $index++]  = 'cellule_i';
        }
        if ($this->isColumnModified(IncidentTableMap::COL_ETAT_I)) {
            $modifiedColumns[':p' . $index++]  = 'etat_i';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'cellule_i':
                        $stmt->bindValue($identifier, $this->cellule_i, PDO::PARAM_INT);
                        break;
                    case 'etat_i':
                        $stmt->bindValue($identifier, $this->etat_i, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getCelluleI();
                break;
            case 2:
                return $this->getEtatI();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCelluleI(),
            $keys[2] => $this->getEtatI(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aEtatIncident) {
                ...
                $result[$key] = $this->aEtatIncident->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCelluleI($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setEtatI($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(IncidentTableMap::COL_CELLULE_I)) {
            $criteria->add(IncidentTableMap::COL_CELLULE_I, $this->cellule_i);
        }
        if ($this->isColumnModified(IncidentTableMap::COL_ETAT_I)) {
            $criteria->add(IncidentTableMap::COL_ETAT_I, $this->etat_i);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCelluleI($this->getCelluleI());
        $copyObj->setEtatI($this->getEtatI());
    ...
    {
        if ($v === null) {
            $this->setCelluleI(NULL);
        } else {
            $this->setCelluleI($v->getId());
        }
    ...
    {
        if ($this->aCellule === null && ($this->cellule_i != 0)) {
            $this->aCellule = ChildCelluleQuery::create()->findPk($this->cellule_i, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCellule->addIncidents($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildEtatIncident object.
     *
     * @param  ChildEtatIncident $v
     * @return $this|\Incident The current object (for fluent API support)
     * @throws PropelException
     */
    public function setEtatIncident(ChildEtatIncident $v = null)
    {
        if ($v === null) {
            $this->setEtatI(NULL);
        } else {
            $this->setEtatI($v->getId());
        }

        $this->aEtatIncident = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildEtatIncident object, it will not be re-added.
        if ($v !== null) {
            $v->addIncident($this);
        }
    ...
    /**
     * Get the associated ChildEtatIncident object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildEtatIncident The associated ChildEtatIncident object.
     * @throws PropelException
     */
    public function getEtatIncident(ConnectionInterface $con = null)
    {
        if ($this->aEtatIncident === null && ($this->etat_i != 0)) {
            $this->aEtatIncident = ChildEtatIncidentQuery::create()->findPk($this->etat_i, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEtatIncident->addIncidents($this);
             */
        }

        return $this->aEtatIncident;
    }
    ...
    {
        if (null !== $this->aCellule) {
            $this->aCellule->removeIncident($this);
        }
        if (null !== $this->aEtatIncident) {
            $this->aEtatIncident->removeIncident($this);
        }
        $this->id = null;
        $this->cellule_i = null;
        $this->etat_i = null;
